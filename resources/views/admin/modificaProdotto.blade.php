            ...
            <div class="mb-3">
                ...
                @if (isset($prodotto) && $prodotto->foto)
                    <div class="mb-3">
                        ...
                        <img src="{{ isset($prodotto->foto) ? asset('img/shop/' . $prodotto->foto) : '' }}"
                ...
                <div class="d-flex justify-content-between">
                    @if (isset($prodotto->id_prodotto) && $prodotto != null)
                        ...
                        <button type="submit" class="btn btn-success"
                            onclick="event.preventDefault(); checkProdotto()">Salva</button>
                    @else
                    <button type="button" class="btn btn-secondary" onclick="window.history.back()" >Annulla</button>
                        <button type="submit" class="btn btn-success"
                            onclick="event.preventDefault(); checkProdotto()">Aggiungi</button>
                    @endif
                </div>
                </form>
            </div>
