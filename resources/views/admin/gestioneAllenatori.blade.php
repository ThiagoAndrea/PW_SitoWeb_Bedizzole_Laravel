...
<div class="container text-center">
    <div class="container container-gestioneRosa">
        <div class="titolo-squadra">
            <div class="row">
                <div class="col">
                    <a href="{{route('allenatori.create')}}" class="btn btn-success add-news"><iconify-icon
                            icon="carbon:add-filled"></iconify-icon> Aggiungi nuovo allenatore</a>
                </div>
            </div>
        </div>
            ...
            <div class="row header">
                ...
                @foreach ($allenatori as $allenatore)
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <a href="{{route('allenatori.edit', ['allenatori' => $allenatore->id_allenatore ])}}" class="btn btn-light">
                                            <iconify-icon icon="mdi:pencil"></iconify-icon> Modifica
                                        </a>
                                        <a href="{{route('allenatori.destroy', ['allenatori' =>$allenatore -> id_allenatore])}}" class="btn btn-danger">
